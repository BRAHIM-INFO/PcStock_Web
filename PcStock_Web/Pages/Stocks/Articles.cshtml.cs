...
namespace PcStock_Web.Pages.Stocks
{
    public class ArticlesModel : PageModel
    {
        ...
        //public IActionResult OnPostUpdateArticle(string articleRef, string intitule, string intitule2, string intitule3, string famille, string lieu_sto, string casier)
        //{
        //    // 1. تحديث الـ SQLite (للسرعة والعرض الفوري)
        ...
        //    // 2. تحديث الـ DBF الأصلي (ليراه برنامج PCSTOCK)
        //    // نستخدم نفس المنطق السابق عبر OdbcConnection...

        //    return new JsonResult(new { success = true, message = "Article mis à jour avec succès dans SQLite!" });
        //}
    }
}